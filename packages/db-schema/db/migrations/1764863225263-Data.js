module.exports = class Data1764863225263 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "attribute" ("id" character varying NOT NULL, "kind" character varying(12) NOT NULL, "target_id" text NOT NULL, "key" text NOT NULL, "value" text NOT NULL, CONSTRAINT "PK_b13fb7c5c9e9dff62b60e0de729" PRIMARY KEY ("id"))`)
    }
